...
- [Assignment 01](./Assignment-01) — Static web page with text formatting tags (tabular format)
- [Assignment 02](./Assignment-02) — Personal portfolio page (HTML, CSS, Bootstrap)
- [Assignment 03](./Assignment-03) — Dynamic fashion store / e-commerce web app
- [Assignment 04](./Assignment-04) — Interactive data visualization dashboard (weather)
- [Assignment 05 — JourneyHub](./Assignment-05) — Travel agency website (Node.js, Express, MongoDB)
- [Assignment 06](./Assignment-06) — Doctor appointment booking system (Node.js, Express, MongoDB)
...
## Proof of Work
See [PROOF.md](./PROOF.md) for setup, commit history, and deployment screenshots.
